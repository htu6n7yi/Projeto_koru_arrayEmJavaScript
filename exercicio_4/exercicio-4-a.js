//Usando findIndex para encontrar a posição da primeira tarefa incompleta
...
const primeiraTarefaNaoCompletada = tasks.findIndex(
  (task) => task.completed === false
);

console.log(primeiraTarefaNaoCompletada);
