...
inventory.forEach(product => {
    // Usando template literals (crases) para criar uma string formatada
    const productInfo = `Nome: ${product.name} | Preço: R$${product.price},00 | Estoque: ${product.stock} unidades`;
