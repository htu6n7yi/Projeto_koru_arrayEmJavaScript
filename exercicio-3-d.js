...
const alunosComMedias85 = students.filter((student) => {

  //calculando a média das notas
  const media = student.grades.reduce((sum, grade) => sum  + grade, 0 ) / student.grades.length;

  return student.active && media > 85;
}
)

console.log(alunosComMedias85.map((student) => student.name));