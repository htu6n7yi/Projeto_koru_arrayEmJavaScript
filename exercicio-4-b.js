//Usando some para verificar se existe alguma tarefa de baixa prioridade completa
...
const tarefaDeBaixaPrioridadeCompleta = tasks.some(
  (task) => task.priority === "baixa" && task.completed
);

if (tarefaDeBaixaPrioridadeCompleta) {
  console.log("Existe pelo menos uma tarefa de baixa prioridade completa.");
} else {
  console.log("Não existe nenhuma tarefa de baixa prioridade completa.");
}
